    ...
    public partial class v7 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyInformations", x => x.CompanyInformationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Advertisements_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(55)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskEntities", x => x.TaskEntityId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertisementOrder", x => new { x.AdvertisementsAdvertisementId, x.OrdersOrderId });
                    table.ForeignKey(
                        name: "FK_AdvertisementOrder_Advertisements_AdvertisementsAdvertisementId",
                        column: x => x.AdvertisementsAdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "AdvertisementId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertisementOrder_Orders_OrdersOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdvertisementOrder_OrdersOrderId",
                table: "AdvertisementOrder",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Advertisements_OfferId",
                table: "Advertisements",
                column: "OfferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskEntities_ApplicationUserId",
                table: "TaskEntities",
                column: "ApplicationUserId");
